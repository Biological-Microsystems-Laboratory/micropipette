...
%DIF DEL manuscript-old.tex   Fri Jul 14 15:15:30 2017
%DIF ADD manuscript.tex       Fri Jul 14 14:33:46 2017
...
\DIFaddbegin \DIFadd{For a video on operation see }\nameref{S1_Video} \DIFadd{and }\nameref{S2_Video}\DIFadd{.  
...
The plunger part is inserted in the body and the syringe assembly is pushed in and locked from the syringe flanges to the body part to complete assembly(fig.~\ref{fig3}\DIFaddbegin \DIFadd{, }\nameref{S1_Video}\DIFaddend ).
...
\DIFdelendFL \DIFaddbeginFL \begin{tabular}{|l|l|r|l|}
		\DIFaddendFL \hline
	\DIFdelbeginFL \DIFdelFL{Part         }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{30-300 mL Configuration:              }& \DIFaddFL{Source            }\DIFaddendFL & Unit Price & \DIFdelbeginFL \DIFdelFL{Source         }%DIFDELCMD < & %%%
\DIFdelFL{Part number }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Part Number }\DIFaddendFL \\ \hline
	Filament                              & \DIFaddbeginFL \DIFaddFL{Makerbot          }& \DIFaddendFL \$1.63     & \DIFdelbeginFL \DIFdelFL{Makerbot       }%DIFDELCMD < & %%%
\DIFdelendFL NA          \\ \hline
	1 mL Syringe                          & \DIFdelbeginFL \DIFdelFL{\$0.15     }%DIFDELCMD < & %%%
\DIFdelendFL BD Biosciences    & \DIFaddbeginFL \DIFaddFL{\$0.15     }& \DIFaddendFL 309628      \\ \hline
	\DIFdelbeginFL \DIFdelFL{Bolt         }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{M3 Bolt, 35 mm                        }& \DIFaddFL{McMaster-Carr     }\DIFaddendFL & \$0.12     & \DIFdelbeginFL \DIFdelFL{McMaster-Carr  }%DIFDELCMD < & %%%
\DIFdelendFL 91287A026   \\ \hline
	\DIFaddbeginFL \DIFaddFL{M3 }\DIFaddendFL Nut                                & \DIFaddbeginFL \DIFaddFL{McMaster-Carr     }& \DIFaddendFL \$0.01     & \DIFdelbeginFL \DIFdelFL{McMaster-Carr  }%DIFDELCMD < & %%%
...
\DIFdelendFL \DIFaddbeginFL \begin{tabular}{|l|l|r|l|}
	\DIFaddendFL \hline
	\DIFdelbeginFL \DIFdelFL{Part         }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{100-1000 mL configuration:             }& \DIFaddFL{Source            }\DIFaddendFL & Unit Price & \DIFdelbeginFL \DIFdelFL{Source         }%DIFDELCMD < & %%%
\DIFdelFL{Part number }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Part Number }\DIFaddendFL \\ \hline
	Filament                               & \DIFaddbeginFL \DIFaddFL{Makerbot          }& \DIFaddendFL \$1.63     & \DIFdelbeginFL \DIFdelFL{Makerbot       }%DIFDELCMD < & %%%
\DIFdelendFL NA          \\ \hline
	3 mL Syringe                           & \DIFdelbeginFL \DIFdelFL{\$0.73     }%DIFDELCMD < & %%%
...
\DIFdelendFL 90591A121   \\ \hline
	...
	\DIFdelbeginFL \DIFdelFL{total        }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{1000 uL Tips (10)                      }& \DIFaddFL{Fisher Scientific }\DIFaddendFL & \$\DIFdelbeginFL \DIFdelFL{6.63     }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.41     }\DIFaddendFL & \DIFaddbeginFL \DIFaddFL{02-707-400  }\\ \hline
	& \DIFaddFL{Total             }& \DIFaddFL{\$4.84     }\DIFaddendFL &            \\ \hline
\end{tabular}
\DIFaddbeginFL \begin{flushleft} \DIFaddFL{*Spring Specifications: Overall length 38 mm, OD 7.62 mm, wire diameter 0.56 mm, Max load 0.86 kg, with closed and flat ends. Also available from McMaster-Carr P/N: 9657K347.
}\end{flushleft}
...
\DIFdelbegin \DIFdel{Validation testing preformed with the existing graduations printed on the syringes did }\DIFdelend \DIFaddbegin \DIFadd{Using the adjusted syringe graduation scale, our printed pipette meets ISO 8655 standards, but using the existing syringe graduation scale does }\DIFaddend not meet the ISO \DIFdelbegin \DIFdel{standards}\DIFdelend \DIFaddbegin \DIFadd{standard for accuracy}\DIFaddend .  
According to ISO 8655 for a pipette with the maximum nominal volume of 1000 $\mu$L the systematic error cannot exceed 8 $\mu$L and the random error cannot exceed 3 $\mu$L \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{ISO8655}}%DIFAUXCMD
}\DIFaddend .
...
This error was exaggerated while transferring larger volumes \DIFaddbegin \DIFadd{(fig.~\ref{fig4}, and fig.~\ref{fig5})}\DIFaddend .
After further investigation we realized that the \DIFaddbegin \DIFadd{water in the tip pulls on the air due to gravity which causes the air to expand slightly, but enough to make measuring with the graduations inaccurate.
The }\DIFaddend graduations are intended to measure incompressible fluids within the syringe while we were using them to measure air while under vacuum.
\DIFdelbegin \DIFdel{Because the syringe graduations were used to measure the air under vacuum it }\DIFdelend \DIFaddbegin \DIFadd{The syringe graduations }\DIFaddend could not be expected to serve as a 1:1 volume ratio of \DIFdelbegin \DIFdel{water that was }\DIFdelend \DIFaddbegin \DIFadd{air to water }\DIFaddend pulled into the tip\DIFdelbegin \DIFdel{because under vacuum }\DIFdelend \DIFaddbegin \DIFadd{, because }\DIFaddend the air had expanded \DIFaddbegin \DIFadd{under vacuum}\DIFaddend .
This explains the negative systematic error we were experiencing.
\DIFdelbegin \DIFdel{The water in the tip pulls on the air due to gravity which causes it to expand slightly but enough to make measuring with the graduation in this way inaccurate.
}\DIFdelend \DIFaddbegin 

\DIFaddend Our solution was to replace the built-in scale with a scale that accounted for the expansion.
\DIFdelbegin \DIFdel{Using the data from our initial testing we calculated a factor for the expansion and used that to make the new scale }\DIFdelend \DIFaddbegin \DIFadd{We compared expected volumes with actual measurements and noticed a linear relationship.
We scaled up the graduations by a factor of 1:1.027 for both the 100-1000 $\mu$L, and 30-300 $\mu$L configurations.
These scales were exported to portable document format (PDF) so that they are most easily printed to scale by an end user.
These adjusted scales are printed on paper or a transparency sheet and taped onto the syringe with the zero at the plunger when the pipette is in the latched position }\DIFaddend (\nameref{S1_Fig} and \nameref{S1_Fig}\DIFdelbegin \DIFdel{.)}\DIFdelend \DIFaddbegin \DIFadd{).
}\DIFaddend With the new scale taped on the syringe our validation testing met the ISO 8655 standard.
...
\DIFaddbegin \begin{figure}
	\caption{
		{\bf \DIFaddFL{Comparison of the accuracy, or systematic error, between 100-1000 $\mu$L pipettes.}} \DIFaddFL{The box plot indicates the range of the ISO standard, the plotted circle indicates the commercial pipette, and the plotted squares are the printed pipette. Empty squares are with the printed pipette with our adjusted graduation scale, and the filled squares are measurements taken with the syringe's existing graduations. (Data from Table \ref{table3})
	}}
	\label{fig4}
\end{figure}
...
\begin{figure}
	\caption{
		{\bf \DIFaddFL{Comparison of the accuracy, or systematic error, between 30-300 $\mu$L pipettes.}} \DIFaddFL{The box plot indicates the range of the ISO standard, the plotted circle indicates the commercial pipette, and the plotted squares are the printed pipette. Empty squares are with the printed pipette with our adjusted graduation scale, and the filled squares are measurements taken with the syringe's existing graduations. (Data from Table \ref{table4})
	}}
	\label{fig5}
\end{figure}

\DIFaddend Our printed pipette improves on existing open design pipettes in several ways. 
...
\DIFaddbegin \DIFadd{This creates a limitation for users who may not have access to the proprietary software used to make the design.
Fortunately the produced STL files are universal and can be imported an modified by any CAD software.
}

\DIFadd{The luer to pipette tip connection is a good candidate for a 3D printed solution.
...
\DIFaddbegin \DIFadd{It's our hope that this project is under continuous development where improvements and compatibility with different syringes and printers can be crowd-sourced from community contributors.
}\DIFaddend 
...
\subsection*{S1 Video}
\label{S1_Video}
{\bf Video showing assembly\DIFdelbegin \DIFdel{and demonstration of operation}\DIFdelend .} Assembly of the pipette in the 100-1000 $\mu$L and 30-300 $\mu$L configuration is \DIFdelbegin \DIFdel{preformed. 
https: //www.youtube.
com/watch?v=D8y5WUYpcW0
}\DIFdelend \DIFaddbegin \DIFadd{performed. 
Also available at: }\href{https://youtu.be/kmtHi_KYfWw}{https://youtu.be/kmtHi\_KYfWw}

\subsection*{\DIFadd{S2 Video}}
\label{S2_Video}
{\bf \DIFadd{Video showing operation.}} \DIFadd{Demonstration of how the pipette functions.
Also available at: }\href{https://youtu.be/2W-8hwV7r3c}{https://youtu.be/2W-8hwV7r3c}
\DIFaddend 
