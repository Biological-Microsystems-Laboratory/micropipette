...
A small amount of parrifin wax is applyed to the screw to prevent slop from causeting the set point to drift after each acuation.
...
Most significatly the user is able to adjust the syringe accuratly without verifying the volume with a scale.
In additon the assembly requires no permanent connections using tape or glue which allows for re-configurationorn and easy replacment of parts.
