...
Previous 3D printed designs have gotten around this limitation by using a flexible membrane to make an airtight tube.
...
Then the tip immersed in fluid and drawn in by actuating the lever with the palm or fingers.
...
\subsection*{Adjusted Syringe Graduations}
...
\begin{table}[]
\centering
\caption{Parts list and cost to build the pipette}
\label{table1}
\begin{tabular}{|l|l|l|l|}
\hline
             & Unit price & Source         & Part number \\ \hline
Filiment     & \$1.63     & Makerbot       & NA          \\ \hline
...
Spring       & \$4.14     & McMaster-Carr  & 94125K542   \\ \hline
Washers      & ??         & McMaster-Carr  & ??          \\ \hline
Total        & \$6.78     &                &             \\ \hline
\end{tabular}
\end{table}

% cost for each part filiment,syringe hardware
% tips used
% syringes used
% printer used and settings


%Testing taken with the original scale along with the adjusted scale is shown in table 1 and 2.
