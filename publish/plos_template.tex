...
% remove this package and figure for submission of manuscript
\usepackage{graphicx}
...
The open source software and has spawed the areas of open source hardware, including such as circuit boards computers (arduio, raspberrpi) as well as 3D printers themselves(reprap). 
...
\begin{figure}
\includegraphics[scale=1]{figure-images/rendering-assembly4.jpg} % take image out for final manuscript
\caption{
...
\begin{figure}
\includegraphics[scale=1]{figure-images/pipette-disassembled.JPG} % take image out for final manuscript
\includegraphics[scale=1]{figure-images/pipette-assembled.JPG} % take image out for final manuscript
\caption{
{\bf Bold the first sentence.}  Rest of figure caption.  
}
