...
The adjustable point is the set point, which determines the volume of fluid that will be drawn into the pipette and dependes on the position of the screw.
The system is spring loaded towards the set point.
A springed notch, in the plunger shaft part, and a groove, in the body part, hold the plunger at the reset position where it can be released by pressing in the notch.
...
3D parts were designed in Blender and SolidWorks and printed by Fineline Protoypeing via selective laser sintering. 
Additional materials include a spring, a nut and bolt and two washers.

\subsection*{Validation}

The pipette was validated and compared to a commerical pipette. 
...
To test the pipette the same volume was pipetted 50 times without moveing or re-adjusting the set point. 
The printed pipette's accuracy and precicion was charaterized and compared to a commericial pipette.
The printed pipette and a series of commericial pipettes were tested at volumes of 20 $\mu$L 50 $\mu$L and 200 $\mu$L.
The printed pipette was adjusted to the the target volume by eye from the syring graduations, and the resulting volume was measured and repeated 5 times to account for varibility.
Measurment were taken from the commericial pipette in a similar way. 

To test user friendliness and feasibilty for useing the pipette without verifing with a scale, data was also gathered from novice users.
After a quick overview of the opperation of the pipette measurments were taken after the volunteers adjusted the pipette to 200, 50, 20 and 10 $\mu$L.
After the first attempt was measured on the scale the volunteer was allow to adjust the set point and re-measure untill within 15\% of the target volume was reached.

% Results and Discussion can be combined.
\section*{Results and Discussion}

Our printed pipette had a comparable accuracy to a commerical pipette (table 1).
The commerical pipette has a digitial readout that allows the user to adjust precisly to set values where the printed pipette is adjusted by eye according to graduations.
This is certianly the cause of the lower accuracy and wider deviation although it's preforamce is impressive. 

The novice user data demonstrates that the pipette set point is user friendly and is capable of accurate measurments without validating with a scale (Figure3).
